...
<body>
  <div class="d-flex justify-content-center align-items-center full-height">
    <div class="card bg-dark text-white border-0" style="width: 900px; height: 700px; border-radius: 20px; overflow: hidden;">
      <img src="<?php echo base_url('img/page-12.png')?>" class="card-img" alt="Paris Background" style="height: 100%;">
      <div class="card-img-overlay d-flex flex-column justify-content-between text-center">


        <div class="center-container">
  <div class="question-card">
    <div class="question-header">Apakah maksud subjek?</div>
    <div class="options">
      <button id="option1" data-value="A" style="text-align: left;">A. Subjek ialah perbuatan atau sifat.</button>
      <button id="option2" data-value="B" style="text-align: left;">B. Subjek ialah nama orang, haiwan atau benda.</button>
      <button id="option3" data-value="C" style="text-align: left;">C. Subjek ialah masa sesuatu perkara berlaku.</button>
      <button id="option4" data-value="D" style="text-align: left;">D. Subjek ialah tempat sesuatu berlaku.</button>
      <button id="submitBtn" class="submit-btn" style="background-color: #ffcf01; color: black;">Hantar</button>
      <small style="font-size: 0.8rem; color: black; font-family: sans-serif;">Your name will be shared</small>
       ...
       <div class="mt-auto mb-1">
            <p style="color: black;">Klik butang untuk ke halaman seterusnya <a href="<?php echo base_url('apps/pagesThirteen');?>">
