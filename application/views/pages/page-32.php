...
<body>
  <div class="d-flex justify-content-center align-items-center full-height">
    <div class="card bg-dark text-white border-0" style="width: 1200px; height: 700px; border-radius: 20px; overflow: hidden;">
      <img src="<?php echo base_url('img/32.png')?>" class="card-img" alt="Paris Background" style="height: 100%;">
    ...
    <a href="<?php echo base_url('apps/pagesTwentySix');?>" class="btn px-5 custom-btn">SEBELUMNYA</a>
    <a href="<?php echo base_url('apps/pagesTwentyEight');?>" class="btn px-5 custom-btn">SETERUSNYA</a>
  </div>
