...
<body>
  ...
  <div class="image-area">
    <img src="<?php echo base_url('img/w4.png')?>" alt="Abang membaca buku" width="400">
  </div>

    <textarea class="custom-input" id="userAnswer-w4" rows="3" cols="80" placeholder="Tulis jawapan anda di sini..."><?php echo isset($val) ? $val->answer : ''; ?></textarea>



        <div class="d-flex justify-content-between mt-auto mb-0 px-4">
    <a href="<?php echo base_url('apps/pagesThirty');?>" class="btn px-5 custom-btn">SEBELUMNYA</a>

        <a href="#" class="btn px-5 custom-btn" id="nextBtn">SETERUSNYA</a>
...
<script>
  ...
  $(document).ready(function() {
      $('#nextBtn').on('click', function(e) {
        ...
        const textarea = document.querySelector('#userAnswer-w4');
        const answer = textarea.value.trim();
        ...
        $.ajax({
          ...
          success: function (response) {
              ...
              window.location.href = "<?php echo base_url('apps/pageEnd');?>";
          },
          error: function () {
              // Still redirect even if saving fails
              window.location.href = "<?php echo base_url('apps/pagesThirtyOne');?>";
          }
      });
