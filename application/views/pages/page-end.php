...
<body>
  <div class="d-flex justify-content-center align-items-center full-height">
    <div class="card bg-dark text-white border-0" style="width: 1200px; height: 700px; border-radius: 20px; overflow: hidden; position: relative;">
      <img src="<?php echo base_url('img/end.png')?>" class="card-img" alt="Paris Background" style="height: 100%;">
      <div class="card-img-overlay d-flex flex-column justify-content-between text-center">
        ...
        <!-- <h2 class="welcome-text" style="color: #FFD700;font-size: 30px;text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);">Klik Butang Hantar </h2> -->
        ...
        <div class="mt-auto mb-5">
          ...
          <a href="<?php echo base_url('apps/hantar');?>" class="btn px-5 custom-btn">TAMAT & HANTAR</a>
        </div>
