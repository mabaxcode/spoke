...
<body>
  ...
  <div class="image-area">
    <img src="<?php echo base_url('img/dd1.png')?>" alt="Abang membaca buku" width="400">
  </div>
  ...
  <div class="drop-area">
    ...
    <?php if( isset($done) && $done == '1' ){ ?>
        <a href="<?php echo base_url('apps/pagesTwentyFour');?>" class="btn px-5 custom-btn">SETERUSNYA</a>
    <?php } ?>
  </div>
...
<script>
    ...
    const correctAnswer = ["Abang", "membaca", "buku", "setiap hari"];
    ...
    function checkAnswer() {
        ...
        if (userAnswer.every(word => word !== "")) {
            ...
            // alert("✅ Betul! Ayat lengkap: Abang membaca buku setiap hari.");
    ...
    function insert_log(userAnswer) {
        // $.post("<?php echo base_url('apps/insertLogActivityTrue');?>",
        ...
        $.ajax({
            ...
            type: "POST",
            data: {userAnswer:userAnswer,type:'1'},
            dataType: "json",
    ...
    function insert_log_wrong(userAnswer) {
        // alert("Log activity wrong function called.");
        // $.post("<?php echo base_url('apps/insertLogActivityWrong');?>",
        // { userAnswer: userAnswer },
        // function (data) {
        //     // Optional: handle response
        //     // alert("Log activity inserted successfully.");
        // });
