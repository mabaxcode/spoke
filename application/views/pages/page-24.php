...
<body>
  <div class="d-flex justify-content-center align-items-center full-height">
    ...
    <div class="word" draggable="true">Ibu</div>
    <div class="word" draggable="true">ayam goreng</div>
    <div class="word" draggable="true">memasak</div>
    <div class="word" draggable="true">di dapur</div>
  </div>

  <div class="image-area">
    <img src="<?php echo base_url('img/dd2.png')?>" alt="Abang membaca buku" width="400">
  </div>
 ...
 <?php 
  ...
  <div class="drop-area">
    ...
    <a href="<?php echo base_url('apps/pagesTwentyThree');?>" class="btn px-5 custom-btn">SEBELUMNYA</a>
    <?php if( isset($done) && $done == '1' ){ ?>
    <a href="<?php echo base_url('apps/pagesTwentyFive');?>" class="btn px-5 custom-btn">SETERUSNYA</a>
    <?php } ?>
  </div>
...
<script>
    ...
    const correctAnswer = ["Ibu", "memasak", "ayam goreng", "di dapur"];
    ...
    function insert_log(userAnswer) {
        ...
        $.ajax({
            ...
            type: "POST",
            data: {userAnswer:userAnswer,type:'2'},
            dataType: "json",
