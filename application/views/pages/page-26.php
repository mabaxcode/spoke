...
<body>
  <div class="d-flex justify-content-center align-items-center full-height">
    ...
    <div class="word" draggable="true">sampah</div>
    <div class="word" draggable="true">Kakak</div>
    <div class="word" draggable="true">menyapu</div>
    <div class="word" draggable="true">di halaman rumah</div>
  </div>

  <div class="image-area">
    <img src="<?php echo base_url('img/dd4.png')?>" alt="Abang membaca buku" width="400">
  </div>
 ...
 <?php 
  ...
  <?php } ?>
    ...
    <a href="<?php echo base_url('apps/pagesTwentyFive');?>" class="btn px-5 custom-btn">SEBELUMNYA</a>
        <?php if( isset($done) && $done == '1' ){ ?>
    <a href="<?php echo base_url('apps/pagesTwentySeven');?>" class="btn px-5 custom-btn">SETERUSNYA</a>
    <?php } ?>
  </div>
...
<script>
    ...
    const wordBank = document.getElementById("wordBank");
     ...
     const correctAnswer = ["Kakak", "menyapu", "sampah", "di halaman rumah"];
    ...
    function checkAnswer() {
        ...
        if (userAnswer.every(word => word !== "")) {
            ...
            // alert("✅ Betul! Ayat lengkap: Kakak menyapu sampah di halaman rumah.");
            alert("✅ Jawapan Disimpan!");
            insert_log(userAnswer);
            window.location.href = "<?php echo base_url('apps/pagesTwentySeven');?>";
            } else {
    ...
    function insert_log(userAnswer) {
        ...
        $.ajax({
            ...
            type: "POST",
            data: {userAnswer:userAnswer,type:'4'},
            dataType: "json",
