...
<body>
  ...
  <div class="image-area">
    ...
    <textarea class="custom-input" id="userAnswer-w3" rows="3" cols="80" placeholder="Tulis jawapan anda di sini..."><?php echo isset($val) ? $val->answer : ''; ?></textarea>
...
<script>
  ...
  $(document).ready(function() {
      $('#nextBtn').on('click', function(e) {
        ...
        const textarea = document.querySelector('#userAnswer-w3');
        const answer = textarea.value.trim();
