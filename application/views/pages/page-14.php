...
<body>
  <div class="d-flex justify-content-center align-items-center full-height">
    <div class="card bg-dark text-white border-0" style="width: 900px; height: 700px; border-radius: 20px; overflow: hidden;">
      <img src="<?php echo base_url('img/page-14.png')?>" class="card-img" alt="Paris Background" style="height: 100%;">
  ...
  <div class="question-card">
    ...
    <div class="options">
      <button id="option1" data-value="1">Ayat tunggal ialah ayat yang mengandungi dua subjek dan dua predikat.</button>
      <button id="option2" data-value="2">Ayat tunggal ialah ayat yang mengandungi satu subjek dan dua predikat.</button>
      <button id="option3" data-value="3">Ayat tunggal ialah ayat.</button>
      <button id="option4" data-value="4">Ayat tunggal ialah ayat yang mengandungi satu subjek dan satu predikat.</button>
      ...
      <small style="font-size: 0.8rem; color: black; font-family: sans-serif;">Your name will be shared</small>
       ...
       <div class="mt-auto mb-1">
            <p style="color: black;">Klik butang untuk ke halaman seterusnya <a href="<?php echo base_url('apps/pagesFourteen');?>">
